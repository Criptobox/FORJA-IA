#!/usr/bin/env node
/** Prism AI — Empaquetar el kit de efectos dentro del bundle.
 *
 ...
 * caminos se rompe en silencio el día que ese CDN no responde — y Prism no
...
console.log(`prism-fx empaquetado: ${css.length} car. de CSS + ${js.length} car. de JS`);
