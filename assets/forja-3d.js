/* forja-3d — WebGL propio, sin librería. Local, ~6 KB.
 *
 ...
 *
 * Tres reglas, las mismas que `forja-fx.js` mas una:
 ...
 *
 * `window.__forja3dActivo` se pone a `true` solo cuando de verdad arranca
