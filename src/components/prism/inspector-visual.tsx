 ...
 *
 * Monta las reglas puras de `lib/prism/inspector-checks.ts` sobre la página
...
import {
  ...
  type ReglaId,
  type Severidad,
} from "@/lib/prism/inspector-checks";
...
function describir(el: Element, vw: number, vh: number): ElementoInspeccionable {
