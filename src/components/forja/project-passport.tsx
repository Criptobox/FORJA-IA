...
import { buildPassport, passportSumario } from "@/lib/forja/passport";
  ...
  return (
    <span
      ...
      className={cn(
        ...
        tone === "accent" && "border-forja-violet/40 bg-forja-violet/10 text-forja-violet",
...
export function ProjectPassportCard({ map }: { map: ProjectMap | null }) {
  ...
  return (
    <div className="mx-3 mb-3 rounded-xl border border-border/60 bg-gradient-to-br from-forja-violet/[0.05] to-forja-cyan/[0.04] p-3">
      <div className="flex items-center justify-between gap-2">
        <p className="flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
          <Layers className="size-3.5 text-forja-violet" /> Ficha del proyecto
        </p>
