...
import { isFreeModel, KEYLESS_PROVIDERS } from "@/lib/forja/free-models";
import { splitModelKey } from "@/lib/forja/types";
import { separarEtiquetasPensamiento } from "@/lib/forja/razonamiento";
                  ...
                  return (
                    <label
                      ...
                      className={cn(
                        ...
                        checked
                          ? "border-forja-violet bg-forja-violet/10 text-foreground"
                          : "border-border/60 text-muted-foreground hover:border-forja-violet/40"
                      )}
                    >
                ...
                return (
                  <div key={key} className="flex min-h-0 flex-col rounded-xl border border-border/60 bg-card/40">
                    <div className="flex items-center gap-2 border-b border-border/50 px-3 py-2">
                      ...
                      {lane?.running && <Loader2 className="size-3.5 animate-spin text-forja-cyan" />}
      ...
      <DialogContent className="flex h-[86vh] max-w-4xl flex-col gap-0 overflow-hidden p-0 sm:h-[680px]">
        <DialogHeader className="border-b px-5 py-4">
          <DialogTitle className="flex items-center gap-2 text-base">
            <Swords className="size-4 text-forja-violet" /> Arena de modelos
