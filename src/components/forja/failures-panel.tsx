...
import { caducaEn, useFailures, type FailureEntry, type FailureScope } from "@/lib/forja/failures";
      ...
      <DialogContent className="max-h-[85vh] w-[min(94vw,560px)]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <BrainCircuit className="size-4 text-forja-violet" /> Memoria de fallos
          </DialogTitle>
          <DialogDescription>
