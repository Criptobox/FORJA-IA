...
const BRANDS: Record<ModelBrand, ReactNode> = {
  ...
  google: (
    <>
      {tile("#FFFFFF")}
      <defs>
        <linearGradient id="forjaLogoGem" x1="4" y1="20" x2="20" y2="4" gradientUnits="userSpaceOnUse">
  ...
  moonshot: (
    <>
      <defs>
        <linearGradient id="forjaLogoKimi" x1="3" y1="21" x2="21" y2="3" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#2563EB" />
          <stop offset="1" stopColor="#8B5CF6" />
        </linearGradient>
      </defs>
      <rect width="24" height="24" rx="6" fill="url(#forjaLogoKimi)" />
      <path
  ...
  generic: (
    <>
      <defs>
        <linearGradient id="forjaLogoGeneric" x1="3" y1="21" x2="21" y2="3" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#8B5CF6" />
          <stop offset="1" stopColor="#22D3EE" />
        </linearGradient>
      </defs>
      <rect width="24" height="24" rx="6" fill="url(#forjaLogoGeneric)" />
      <path
