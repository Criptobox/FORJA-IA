...
import { ghGetToken, ghSetToken } from "@/lib/forja/github-upload";
import { consejoQr } from "@/lib/forja/qr";
...
export function TransferPanel() {
  ...
  const descargar = () => {
    ...
    a.href = url;
    a.download = `forja-transferencia-${new Date().toISOString().slice(0, 10)}.txt`;
    a.click();
  ...
  return (
    ...
    >
      <h3 className="flex items-center gap-1.5 text-sm font-semibold">
        <ShieldCheck className="size-4 text-forja-cyan" /> Pasar a otro dispositivo
      </h3>
        ...
        {modo === "enviar" ? (
          ...
          <>
            <textarea
              ...
              placeholder="Pega aquí el código que empieza por FORJA1.…"
