...
import { splitModelKey, DEFAULT_SETTINGS } from "@/lib/forja/types";
import { PROVIDER_MAP } from "@/lib/forja/providers";
import { useForja } from "@/lib/forja/store";
import { ghGetToken } from "@/lib/forja/github-upload";
import { GitHubConnect } from "./github-connect";
import { publishAsNewRepo, pushFilesToRepo } from "@/lib/forja/repo-push";
...
import type { ReviewFile } from "@/lib/forja/sandbox-review";
import { isHtmlPath, type SandboxSeed } from "@/lib/forja/sandbox";
          ...
          <div
            className={cn(
              ...
              info.status === "exists"
                ...
                : "border-forja-violet/40 bg-forja-violet/10 text-forja-violet"
            )}
          >
                ...
                <div className="space-y-1.5 border-t px-3 py-2">
                  ...
                  <div className="flex gap-1.5">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="h-8 gap-1 border-forja-violet/40 text-xs text-forja-violet hover:bg-forja-violet/10 hover:text-forja-violet"
                      onClick={fixWithAi}
                      disabled={fixing}
                    >
      ...
      <DialogContent className="flex h-[88vh] max-w-3xl flex-col gap-0 overflow-hidden p-0 sm:h-[680px]">
        <DialogHeader className="border-b px-5 pb-3 pt-4">
          <DialogTitle className="flex items-center gap-2 text-base">
            <FolderGit2 className="size-4 text-forja-violet" /> Repo Studio
          </DialogTitle>
