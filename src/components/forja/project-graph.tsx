...
import { buildGraph, fileRelations, type GraphEdge, type GraphNode } from "@/lib/forja/project-map";
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="shrink-0 space-y-2 border-b border-border/60 p-2.5">
        <input
          ...
          className="h-7 w-full rounded-lg border border-border/60 bg-background px-2.5 text-xs outline-none placeholder:text-muted-foreground/60 focus:border-forja-cyan/60"
        />
