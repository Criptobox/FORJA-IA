...
import { fetchModels } from "@/lib/forja/chat-client";
...
const FEATURES = [
  ...
  { icon: Eye, color: "text-forja-pink", title: "Vista previa en vivo", text: "Si la IA crea una página web, la ves renderizarse mientras escribe." },
  { icon: WandSparkles, color: "text-forja-violet", title: "Modo agente", text: "Bucles de plan → ejecutar → revisar para tareas grandes." },
  { icon: ShieldCheck, color: "text-forja-cyan", title: "100% privado", text: "Tus claves y conversaciones se quedan en tu dispositivo." },
];
...
export function OnboardingDialog({
  ...
  const setOnboardingDone = useForja((s) => s.setOnboardingDone);
          ...
          {Array.from({ length: TOTAL_STEPS }, (_, i) => i + 1).map((n) => (
            <span
              ...
              className={cn(
                ...
                n === step ? "w-6 forja-gradient-bg" : "w-1.5 bg-border"
              )}
            />
          ))}
        </div>
            ...
            <div className="text-center">
              <div className="mb-4 flex justify-center">
                <div className="relative">
                  <div className="absolute inset-0 -z-10 blur-2xl forja-gradient-bg opacity-25" />
                  <ForjaLogo size={64} glow />
                </div>
              </div>
              <h2 className="text-xl font-bold tracking-tight">
                Bienvenido a Forja <span className="forja-gradient-text">IA</span>
              </h2>
              <p className="mx-auto mt-1.5 max-w-sm text-balance text-[13px] leading-relaxed text-muted-foreground">
                Todos tus modelos, forjados en uno. Chatea con las mejores IAs usando
              ...
              <div className="mt-5 flex items-center justify-center gap-2">
                ...
                <Button
                  className="forja-gradient-bg h-9 border-0 text-white hover:opacity-90"
                  onClick={() => setStep(2)}
                >
          ...
          {step === 2 && (
            <div>
              <div className="flex items-center gap-3">
                <div className="flex size-10 shrink-0 items-center justify-center rounded-xl forja-gradient-bg text-white">
              ...
              <div className="mt-4 space-y-2.5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 text-xs text-forja-violet hover:underline"
                >
            ...
            <div>
              ...
              <div className="mt-4 space-y-2">
                {[
                  ...
                  >
                    <p.icon className="mt-0.5 size-4 shrink-0 text-forja-cyan" />
                    <div>
