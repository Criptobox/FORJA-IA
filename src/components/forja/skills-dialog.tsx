...
} from "@/lib/forja/skill-permissions";
import { costeDeSkill } from "@/lib/forja/prompt-actual";
import {
  buscarEnCatalogo,
  parseCatalogo,
  yaInstalada,
...
} from "@/lib/forja/catalogo-skills";
...
export function SkillsDialog({
  ...
  const toggleSkill = useForja((s) => s.toggleSkill);
  const removeSkill = useForja((s) => s.removeSkill);
  const addSkill = useForja((s) => s.addSkill);
      ...
      <DialogContent className="flex h-[86vh] max-w-xl flex-col gap-0 overflow-hidden p-0 sm:h-[600px]">
        <DialogHeader className="border-b px-5 py-4">
          <DialogTitle className="flex items-center gap-2 text-base">
            <Puzzle className="size-4 text-forja-violet" /> Skills
            <span className="rounded-full bg-forja-violet/10 px-2 py-0.5 text-[10px] font-medium text-forja-violet">
              {activeCount} activas
              {costeActivas > 0 && (
        ...
        <div className="space-y-2 border-b px-4 py-3">
          ...
          {creating && (
            <div className="space-y-2 rounded-xl border border-border/60 bg-muted/30 p-3">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-lg border border-input bg-background px-3 py-2 text-xs outline-none focus:border-forja-violet/50"
              />
              {permisosManual && (
          ...
          {pendiente && (
            <div className="space-y-2 rounded-xl border border-forja-violet/40 bg-muted/30 p-3">
              ...
              return (
                <li
                  ...
                  className={cn(
                    ...
                    s.enabled ? "border-forja-violet/40 bg-forja-violet/[0.04]" : "border-border/60 bg-card/50"
                  )}
                >
