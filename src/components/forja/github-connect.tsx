...
import { GH_OAUTH_MSG } from "@/lib/forja/github-oauth";
import {
  GH_ACCOUNT_EVENT,
  GH_TOKEN_URL,
  ghGetAccount,
    ...
    <div className={cn("space-y-2", !compact && "rounded-xl border border-border/60 bg-card/40 px-3 py-3")}>
      ...
      <details className="text-[11px] text-muted-foreground">
        ...
        <div className="mt-2 flex gap-2">
          ...
          <a href={GH_TOKEN_URL} target="_blank" rel="noreferrer" className="inline-flex items-center text-forja-violet underline underline-offset-2">
            Crear
          </a>
        </div>
      </details>
