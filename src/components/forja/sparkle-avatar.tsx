 ...
 *
 * El color hereda del tema: usa `var(--forja-violet)` por defecto (el
 ...
 * con él. Si prefieres el cian fijo de marca, cambia `--forja-violet`
 * por `--forja-cyan` en el `style.color`.
 */
...
export function SparkleAvatar({
  ...
  return (
    <span
      ...
      style={{ width: size, height: size, color: "var(--forja-violet)" }}
    ...
    >
      <svg
        ...
        style={{
          filter: "drop-shadow(0 0 4px color-mix(in oklab, var(--forja-violet) 55%, transparent))",
        }}
        aria-hidden
      >
