 ...
 * selección lo decide lib/forja/slash.ts (probado en Node).
 */
...
import type { SlashCommand, SlashId } from "@/lib/forja/slash";
...
const TINTS: Record<SlashId, string> = {
  imagen: "bg-forja-pink/12 text-forja-pink",
  agente: "bg-forja-violet/12 text-forja-violet",
  resumen: "bg-forja-cyan/12 text-forja-cyan",
  orquesta: "bg-forja-violet/12 text-forja-violet",
  ...
  carrusel: "bg-forja-pink/12 text-forja-pink",
  poster: "bg-amber-500/12 text-amber-600 dark:text-amber-400",
  nuevo: "bg-muted text-muted-foreground",
  snip: "bg-forja-violet/12 text-forja-violet",
  plantillas: "bg-forja-cyan/12 text-forja-cyan",
  wrapped: "bg-forja-pink/12 text-forja-pink",
