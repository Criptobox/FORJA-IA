  ...
  return (
    ...
    >
        ...
        return (
          <div
            ...
            className={cn(
              ...
              activa
                ? "border-border/70 bg-card/80 text-foreground shadow-[inset_0_2px_0_0_var(--forja-violet)]"
                : "border-transparent text-muted-foreground hover:bg-muted/50 hover:text-foreground"
            )}
          >
            <MessageSquare
              className={cn("size-3 shrink-0", activa ? "text-forja-violet" : "opacity-50")}
            />
      ...
      <button
        ...
        onClick={onNew}
        className="ml-1 flex size-6 shrink-0 items-center justify-center rounded-md border border-dashed border-border/70 text-muted-foreground/70 transition hover:border-forja-cyan/60 hover:text-forja-cyan"
      >
