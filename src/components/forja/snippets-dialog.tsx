      ...
      <DialogContent className="max-h-[88vh] overflow-hidden rounded-2xl sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <BookOpen className="size-4 text-forja-violet" />
            Snippets
          </DialogTitle>
          <DialogDescription>
              ...
              {filtered.length === 0 ? (
                ...
                <ul className="flex flex-col gap-1.5">
                  {filtered.map((s) => (
                    <li
                      key={s.id}
                      className="group rounded-xl border border-border/60 bg-card/40 px-3 py-2 transition hover:border-forja-violet/40 hover:bg-forja-violet/[0.05]"
                    >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? "border-forja-violet/40 bg-forja-violet/15 text-forja-violet"
