...
function CodeBlock({
  ...
  return (
    <div
      className="group/code my-3 overflow-hidden rounded-xl border border-forja-violet/20 bg-[#0B0E17] text-[#E6E9F2] shadow-md shadow-black/30"
      data-lang={lang}
    >
