  ...
  return [
    ...
    ...(() => {
      ...
      return [
        ...
        con3d
          ? "Los archivos `forja-fx.css`, `forja-fx.js` y `forja-3d.js` (el motor WebGL) viajan con el proyecto: son locales, no un CDN."
          : "Los archivos `forja-fx.css` y `forja-fx.js` viajan con el proyecto: son locales, no un CDN.",
      ];
    })(),
    "",
  ].join("\n");
