 ...
 * él responde con un bloque ```forja-repaso lleno de tarjetas, y Forja las
...
export const LENGUAJE_BLOQUE = "forja-repaso";
 ...
 *
 * Acepta bloques vallados ```forja-repaso y, por tolerancia, ```json o
