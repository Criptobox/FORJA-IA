 ...
 *
 * Vive en SU propia clave (`forja-repaso-v1`) y no dentro del store principal:
 * es el mismo camino que `forja-usage-v1`. Si mañana las tarjetas crecen o
