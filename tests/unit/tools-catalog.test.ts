...
describe("TOOL_CATALOG", () => {
  ...
  it("el catálogo es EXACTAMENTE este: las del PLAN-V4/V7, read_url, las de la v3.32, las tres de la v3.40, apply_patch de la v4 (edición por parches), visual_review (QA por visión) y verify_project (verificación independiente)", () => {
